 ...
 */
?>
<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>문의 상세 · 파구스 운영</title></head><body>
<h1>문의 상세</h1><p><a href="/admin/inquiries">목록으로</a></p>
...
<form method="post" action="/admin/inquiries/<?= (int) $inquiry['id'] ?>/status">
<?= csrf_field() ?>
<label>처리 상태 <select name="status">
